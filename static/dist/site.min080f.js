(function () { function r(e, n, t) { function o(i, f) { if (!n[i]) { if (!e[i]) { var c = "function" == typeof require && require; if (!f && c) return c(i, !0); if (u) return u(i, !0); var a = new Error("Cannot find module '" + i + "'"); throw a.code = "MODULE_NOT_FOUND", a } var p = n[i] = { exports: {} }; e[i][0].call(p.exports, function (r) { var n = e[i][1][r]; return o(n || r) }, p, p.exports, r, e, n, t) } return n[i].exports } for (var u = "function" == typeof require && require, i = 0; i < t.length; i++)o(t[i]); return o } return r })()({
  1: [function (require, module, exports) {
    ...
    var parallax = function parallax() {
      ...
      var fruskaGoraNav = document.querySelector(".js-nav-fruska-gora");
      var fruskaGoraTarget = document.querySelector(".js-fruska-gora-target");
      var fruskaGoraDuration = 3.5;
      fruskaGoraNav.addEventListener("click", function (e) {
        e.preventDefault();
        window.closeMenu();

        if (itsLoco) {
          locoScroll.scrollTo(fruskaGoraTarget, {
            duration: fruskaGoraDuration * 1000
          });
        } else {
          _gsap.default.to(window, {
            duration: fruskaGoraDuration * 0.8,
            scrollTo: fruskaGoraTarget,
            ease: _gsap.Power1.easeInOut
          });
        }
      });
      var negaziranaNav = document.querySelector(".js-nav-negazirana");
      var negaziranaTarget = document.querySelector(".js-negazirana-target");
      var negaziranaDuration = 4;
      negaziranaNav.addEventListener("click", function (e) {
        e.preventDefault();
        window.closeMenu();

        if (itsLoco) {
          locoScroll.scrollTo(negaziranaTarget, {
            duration: negaziranaDuration * 1000
          });
        } else {
          _gsap.default.to(window, {
            duration: negaziranaDuration * 0.8,
            scrollTo: negaziranaTarget,
            ease: _gsap.Power1.easeInOut
          });
        }
      });
      var vitaminskaNav = document.querySelector(".js-nav-vitaminska");
      var vitaminskaTarget = document.querySelector(".js-vitaminska-target");
      var vitaminskaDuration = 5;
      vitaminskaNav.addEventListener("click", function (e) {
        e.preventDefault();
        window.closeMenu();

        if (itsLoco) {
          locoScroll.scrollTo(vitaminskaTarget, {
            duration: vitaminskaDuration * 1000
          });
        } else {
          _gsap.default.to(window, {
            duration: vitaminskaDuration * 0.8,
            scrollTo: vitaminskaTarget,
            ease: _gsap.Power1.easeInOut
          });
        }
      });
      var imunoNav = document.querySelector(".js-nav-imuno");
      var imunoTarget = document.querySelector(".js-imuno-flasa-target");
      var imunoDuration = 5;
      imunoNav.addEventListener("click", function (e) {
        e.preventDefault();
        window.closeMenu();

        if (itsLoco) {
          locoScroll.scrollTo(imunoTarget, {
            duration: imunoDuration * 1000
          });
        } else {
          _gsap.default.to(window, {
            duration: imunoDuration * 0.8,
            scrollTo: imunoTarget,
            ease: _gsap.Power1.easeInOut
          });
        }
      });
      var contactNav = document.querySelector(".js-nav-contact");
      var contactTarget = document.querySelector(".js-contact-target");
      var contactDuration = 5.5;
      contactNav.addEventListener("click", function (e) {
        ...
        if (itsLoco) {
          locoScroll.scrollTo(contactTarget, {
            duration: contactDuration * 1000
          });
        } else {
          _gsap.default.to(window, {
            duration: contactDuration * 0.8,
            scrollTo: contactTarget,
            ease: _gsap.Power1.easeInOut
          });
        }
      });
